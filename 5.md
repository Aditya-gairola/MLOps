...
Using this comparison, the team calculates metrics such as accuracy, precision, and recall (metrics that .md is covered in [3.md](github.com/Aditya-gairola/MLOps/blob/main/3.md)). 
