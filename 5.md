...
Using this comparison, the team calculates metrics such as accuracy, precision, and recall (metrics that .md is covered in [github.com/Aditya-gairola/MLOps/blob/main/3.md](3.md). 
