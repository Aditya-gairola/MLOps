...
---
<img width="1164" height="544" alt="Screenshot from 2026-04-21 12-23-35" src="https://github.com/user-attachments/assets/78c25592-1988-4cf7-bfb7-a58aef96cb68" />

---

The output shows the best parameter is C=1, solver='lbfgs', max_iter=1000. As a DevOps engineer, you don’t need to understand these details to run or deploy the model.
...
<img width="3896" height="2597" alt="image" src="https://github.com/user-attachments/assets/638efc52-204e-4ab0-855c-606a8dcc00f6" />
...
this image can give kind of a mental model.

<img width="4244" height="1951" alt="image" src="https://github.com/user-attachments/assets/597011ef-d179-49dd-a0cb-90d2e124341d" />

running the testing script.

The script will prompt you to enter 15 employee attributes one by one. It then automatically derives 4 additional features and passes all 19 to the model.
...
---
<img width="1046" height="534" alt="Screenshot from 2026-04-21 12-42-20" src="https://github.com/user-attachments/assets/60778458-ca81-439b-bc0d-3f3c4fe641ea" />

---

Now i have a fully trained model saved in artifacts/model.pkl. i have also successfully tested it locally.

## What's Next!
I cannot use a model or give anyone this model to be used in a CLI or Python script right?

I need to give the end user (e.g. HR personnel) an app that uses this model at the backend.

So i will wrap model.pkl in a REST API using FastAPI. Then i use KServe on Kubernetes to serve the model.
